...
public class OverwriteWindowViewModel : ReactiveObject
{
    ...
    {
        DataManager.SetAndSaveConfigValue(() => DataManager.ClientOverwritePath, ClientPath);
        DataManager.SetAndSaveConfigValue(() => DataManager.ServerOverwritePath, ServerPath);
    }
